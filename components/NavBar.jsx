    ...
    <>
      ...
      >
        <a href="#top">
          <Image
            src= {assets.logo}
            className="w-28 cursor-pointer mr-14 h-25 "
            alt=""
          />
        </a>
        <ul
          className={`hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 ${
            isScroll ? "bg-white shadow-lg bg-opacity-50 backdrop-blur-lg" : "bg-white shadow-sm bg-opacity-50 dark:border dark:border-white/50 dark:bg-transparent"
          }  `}
        >
          <li>
        ...
        >
          ...
          <ul>
            ...
            <li>
              <a className="font-Ovo" href="#contact-me" onClick={closeMenu}>
                Contact Me
              </a>
            </li>
          </ul>
